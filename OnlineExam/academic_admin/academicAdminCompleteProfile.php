...
<html lang="en">
<head>
    <title>::..Edit Profile|Academic Admin..::</title>
    <meta charset="utf-8">
...
<div class="row w-100 m-auto" >
    ...
    <form action="" method="post" class="col-lg-9 float-left col px-5 py-2 main mr-5 my-4 border rounded"  style="background-color:#f5f5f5;">
        ...
        <div class="row my-2">
            <div class="col-lg-6">
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminDOB" class="col-sm-5 col-form-label">Date of Birth<span class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <input type="date" class="date form-control" name="dob" id="inputAcaAdminDOB" required>
                    </div>
                </div>
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminGender" class="col-sm-5 col-form-label">Gender<span class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <select class="form-control" id="inputAcaAdminGender" name="gender" required>
                ...
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminBlood" class="col-sm-5 col-form-label">Blood Group</label>
                    <div class="col-sm-7">
                        <select class="form-control" name="bloodGroup" id="inputAcaAdminBlood">
                ...
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminNationality" class="col-sm-5 col-form-label">Nationality</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="inputAcaAdminNationality" name="nationality" placeholder="Enter Nationality">
                    </div>
                </div>
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminNationalId" class="col-sm-5 col-form-label">National ID<span class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="inputAcaAdminNationalId" name="nationalId" placeholder="Enter National ID" required>
                    </div>
                </div>
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminReligion" class="col-sm-5 col-form-label">Religion</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="inputAcaAdminReligion" name="religion" placeholder="Enter Religion">
                    </div>
                </div>
            </div>
            <div class="form col-lg-6">
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminPhone" class="col-sm-5 col-form-label">Phone No<span class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="inputAcaAdminPhone" name="phoneNo" placeholder="Enter Phone no" required>
                    </div>
                </div>
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminEmergContact" class="col-sm-5 col-form-label">Emergency Contact</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="inputAcaAdminEmergContact" name="emergContact" placeholder="Enter Contact no">
                    </div>
                </div>
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminSocialId" class="col-sm-5 col-form-label">Social Network ID</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="inputAcaAdminSocialId" name="socialNetId" placeholder="Enter Social Network Id">
                    </div>
                </div>
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminAltEmail" class="col-sm-5 col-form-label">Alternative E-mail</label>
                    <div class="col-sm-7">
                        <input type="email" class="form-control" id="inputAcaAdminAltEmail" name="email" placeholder="Enter Alternative Email">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row my-2">
            <div class="col-lg-6">
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminAcademicName" class="col-sm-5 col-form-label">Academic Name<span class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="inputAcaAdminAcademicName" name="academicName" placeholder="Enter Academic Name" required>
                    </div>
                </div>
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminAcademicID" class="col-sm-5 col-form-label">ID/Roll No<span class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="inputAcaAdminAcademicID" name="academicId" placeholder="Enter ID/Roll No" required>
                    </div>
                </div>
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminFaculty" class="col-sm-5 col-form-label">Faculty</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="inputAcaAdminFaculty" name="faculty" placeholder="Enter Faculty">
                    </div>
                </div>
            </div>
            <div class="form col-lg-6">
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminDepartment" class="col-sm-5 col-form-label">Department<span class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="inputAcaAdminDepartment" name="department" placeholder="Enter Department" required>
                    </div>
                </div>
                <div class="form-group row mt-3 mx-auto">
                    <label for="inputAcaAdminDesignation" class="col-sm-5 col-form-label">Designation<span class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <select class="form-control" id="inputAcaAdminDesignation" name="designation" required>
        ...
        <div class="row float-right">
            <div class="text-center mb-4 mr-2">
                <button type="reset" class="btn btn-danger mx-auto mt-3 px-3 py-2 rounded" id="acaAdminResetPersonalInfo"><i class="fa fa-refresh"></i> Reset</button>
                <button type="submit" class="btn btn-success mx-auto mt-3 px-3 py-2 rounded" id="compltAcaAdminProfileSubmit" name="submit"><i class="fa fa-check"></i> Submit</button>
            </div>
        </div>
    </form>
</div>
