<?php
require "../apps/controller/addCoordinatorController.php";
...
<div class="row w-100 mx-auto">
    <div class="col-lg-8 float-left col px-5 py-2 main mx-auto my-4 border rounded" style="min-height: 600px;">
        <div class="page-header text-center" >
            <h3 class="mt-3">Add Coordinator</h3>
        </div>
        <hr pb-1>
        <div class="card mx-auto my-lg-5 w-75"  style="box-shadow: 2px 2px 20px gray;">
            <div class="card-body pt-5" style="border-radius: 10px;">
                <form action="" method="post">
                    <p class="mx-auto text-center mb-4" style="font-family: Gotham, Helvetica Neue, Helvetica, Arial,' sans-serif'">* Please fill the form below to add Coordinator<br>** Star ( <span class="text-danger font-weight-bold">*</span> ) sign denotes mandetory fields.</p>
                        ...
                        <div class="form-row mt-3">
                            <label class="col-form-label col-sm-3 ml-auto"><b>Faculty<span class="text-danger">*</span></b></label>
                            <div class="col-sm-5 mr-auto">
                                <input type="text" class="form-control" name="faculty" placeholder="Enter faculty" required>
                            </div>
                        </div>
                        <div class="form-row mt-3">
                            <label class="col-form-label col-sm-3 ml-auto"><b>Department<span class="text-danger">*</span></b></label>
                            <div class="col-sm-5 mr-auto">
                        ...
                        <div class="form-row text-center mr-5 float-right">
                            <a href="coOrdinatorList.php" class="btn btn-secondary my-3 mr-3 float-right px-2 py-2"><span class="fa fa-user-list" aria-hidden="true"></span>Coordinator List</a>
                            <button type="submit" class="btn btn-primary my-3 mr-5 float-right px-4 py-2" name="addCOBtn">ADD</button>
                        </div>
                </form>
            </div>
        </div>
