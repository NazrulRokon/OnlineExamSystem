...
<html lang="en">
	<head>
	  <title>::..Result|Academic Admin..::</title>
        <meta charset="utf-8">
	...
	<body>
		...
		<div class="row w-100 m-auto" >
			...
			<div class="col-lg-9 float-left col px-5 py-2 main mr-5 my-4 border rounded" style="min-height: 800px;">
				...
				<hr class="pb-3">
				<h4 class="mt-3">Exam Result <small></small></h4>
				<hr class="bg-info">
                <div class="row p-0">
                    <div class="col-md-12">
					 ...
					 <table class="table table-lg table-bordered mt-4 mb-lg-5 text-center">
						<thead>
							<tr class="bg-secondary text-light">
								...
								<th scope="col">Objective Marks</th>
								<th scope="col">Writen Marks</th>
