            ...
            <div class="card col-lg-2 border-0 my-4 py-4 px-0 mx-auto" style="background-color: #282828;">
                ...
                <div class="card-body px-0 mt-4">
                    <div class="sidenav col-lg-10 m-auto text-center px-0">
                        <a class="px-0" href="portalList.php"><i class="fa fa-edit m-0"></i> Manage Portal</a>
							...
							<table class="table table-bordered mt-4 mb-lg-5">
							  ...
							  <tbody>
								<tr class="text-center bg-white">
								  <td >111</td>
								  <td class="px-0">Daffodil Versity</td>
								  <td>Dhanmondi</td>
								  <td class="py-0">
									<button class="btn btn-success fa fa-check-square mx-0 btn-sm" id="portaApprove" data-toggle="tooltip" title="Approve Portal" ></button>
									<button class="btn btn-danger fa fa-trash btn-sm" id="portalDelete"  data-toggle="modal" data-target="#deleteportal1" title="Delete portal" ></button>
										<div class="modal fade" id="deleteportal1">
											<div class="modal-dialog">
												<div class="modal-content">
												  <!-- Modal Header -->
												  <div class="modal-header">
													<h4 class="modal-title text-success"><span id="portalInstitute">Daffodil University</span></h4>
													<button type="button" class="close" data-dismiss="modal">&times;</button>
												  </div>

												  <!-- Modal body -->
												  <div class="modal-body">
														<p class="text-danger lead">Are you sure to delete the portal ?</p>
												  </div>
												  <!-- Modal footer -->
												  <div class="modal-footer">
													<button type="button" class="btn btn-danger" id="examPoolDeleteBtn">Delete</button>
												  </div>
												</div>
											</div>
										</div>
										 ...
										 <div class="modal-dialog">
											<div class="modal-content">
											  ...
											  <div class="modal-body text-center">
												<p><b>Portal Id : </b>111</p>
												<p><b>Institue Name : </b>Daffodil International University</p>
												<p><b>Institute Admin : </b>Md. Ali Hossain</p>
												<p><b>Institute Address : </b>Dhanmondi</p>
							...
							<table class="table table-bordered mt-4 mb-lg-5">
							  ...
							  <tbody>
								<tr class="text-center bg-light">
								  <td >SE-<span>23424</span></td>
								  <td class="px-0">Daffodil Versity</td>
								  <td>Dhanmondi</td>
								  <td class="py-0">
									<button class="btn btn-danger fa fa-trash btn-sm" id="portalDelete"  data-toggle="modal" data-target="#deleteportal2" title="Delete portal" ></button>
										<div class="modal fade" id="deleteportal2">
											<div class="modal-dialog">
												<div class="modal-content">
												  <!-- Modal Header -->
												  <div class="modal-header">
