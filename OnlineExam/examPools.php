		...
		<div class="row w-100 m-auto" style=" background-color:#f1f8e9;">
				<div class="col-md-10 mx-auto col px-5 pt-2 main mx-4 mt-4 border" style="min-height: 1000px;">
					<div class="page-header">
						<h2 class="text-center">Exam Pools</h2>
					</div>
					<p class="lead text-center">Find your exam pool to take part in exam.</p>
					<hr>
					<div class="row p-0">
						<div class="col-md-12">
                        ...
                        if ($count_pool > 0) {
                            While ($pool_row = mysqli_fetch_array($pool_exists)) {
                                ...
                                if ($current_date < $exam_date)
                                    $status = "Upcoming";
                                else if ($current_date == $exam_date && $start_time<=$current_time && $current_time<$ending_time)
                                    $status = "Running";
                                ...
                                <div class="card-header p-0">
                                    <div class="col-lg-5 px-3 py-2 float-left text-success text-center">
                                    ...
                                    <div class=" btn-group col-lg-5 py-3 float-left text-center">
                                        <span style="font-weight: 800; font-size: 16px;">
                                            <span class="text-primary" style="font-size: 18px;">Start Within : </span><span id="demo">';
                                ?>
                                    ...
                                    <div class=" btn-group col-lg-2 py-3 px-lg-2 float-right">
                                        <a href="candidates/candidateWaitingPanel.php" class="btn btn-sm btn-success rounded mx-1"  title="Enter exam pool" href="#"><i class="fa fa-play"></i></a>
