...
<div class="row w-100 m-auto" style="background-color:#EEEEEE;">
    <div class="col-sm-5 mx-auto" >
        <div class="card mx-auto my-lg-5"  style="background-color: #e8f5e9; box-shadow: 2px 2px 20px black;">
            ...
            <div class="card-body" style="border-radius: 10px;">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="" aria-describedby="emailHelp" placeholder="Email you use to login">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Questions/Remarks</label>
                        <textarea class="form-control commentTextEditor" id="contuctUsQue" rows="3" placeholder="Questions/Remarks*"></textarea>
                    </div>
                </form>
                <button type="submit" class="btn-lg btn-primary my-3 float-right border-0">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<script>tinymce.init({selector:'.commentTextEditor'});</script>
