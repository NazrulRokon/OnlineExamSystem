                ...
                <div class="form-inline my-2 my-lg-0">
                    <div class="btn-group dropdown" id="examPoolDropdown">
                        ...
                        <div class="dropdown-menu m-2 bg-secondary" aria-labelledby="dropdownMenuButton" id="examPoolDropmenu">
                            <a class="dropdown-item bg-secondary text-light text-center" href="studentProfile.php"><i class="fa fa-user-circle"></i> Profile</a>
                            <div class="dropdown-divider"></div>
...
<div class="row w-100 m-auto" >
    ...
    <div class="col-lg-9 float-left col px-5 py-2 main mr-5 my-4 border rounded"  style="background-color:#f5f5f5;">
        <div class="page-header text-center" >
            <h3 class="mt-3"><span class="text-success"><?php echo " ".$fullname; ?></span>'s profile</h3>
        </div>
        ...
        <div class="row my-3">
            <div class="col-lg-6">
                <div class="row mt-3 mx-auto">
                    ...
                    <div class="col-sm-6">: <span id="firstName"><?php echo $first_name?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">Last Name</div>
                    <div class="col-sm-6">: <span id="lastName"><?php echo $last_name?></span></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">Date of Birth</div>
                    <div class="col-sm-6">: <span id="DOB"><?php echo $dob?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">Gender</div>
                    <div class="col-sm-6">: <span id="gender"><?php echo $gender?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">Blood Group</div>
                    <div class="col-sm-6">: <span id="bloodGrp"><?php echo $blood_group?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">Nationality</div>
                    <div class="col-sm-6">: <span id="nationality"><?php echo $nationality?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">National ID</div>
                    <div class="col-sm-6">: <span id="nationalId"><?php echo $national_id?></span></div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">Religion</div>
                    <div class="col-sm-6">: <span id="religion"><?php echo $religion?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">Phone No.</div>
                    <div class="col-sm-6">: <span id="phone"><?php echo $phone_no?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">Emergency Contact No</div>
                    <div class="col-sm-6">: <span id="emergPhone"><?php echo $emerg_contact?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">Social Network ID</div>
                    <div class="col-sm-6">: <span id="socialId"><?php echo $social_net_id?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">E-mail</div>
                    <div class="col-sm-6">: <span id="email"><?php echo $email?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-6 text-secondary font-weight-bold">Alternative E-mail</div>
                    <div class="col-sm-6">: <span id="altEmail"><?php echo $alt_email?></span></div>
                </div>
            </div>
        </div>
        ...
        <div class="row my-3">
            <div class="col-lg-12">
                <div class="row mt-3 mx-auto">
                    ...
                    <div class="col-sm-8">: <span id="academicName"><?php echo $aca_name?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-4 text-secondary font-weight-bold">ID/Roll No</div>
                    <div class="col-sm-8">: <span id="academicId"><?php echo $aca_id?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-4 text-secondary font-weight-bold">Faculty</div>
                    <div class="col-sm-8">: <span id="faculty"><?php echo $faculty?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-4 text-secondary font-weight-bold">Department</div>
                    <div class="col-sm-8">: <span id="department"><?php echo $department?></span></div>
                </div>
                <div class="row mt-3 mx-auto">
                    <div class="col-sm-4 text-secondary font-weight-bold">Designation</div>
                    <div class="col-sm-8">: <span id="designation"><?php echo $designation?></span></div>
                </div>
            </div>
        </div>
