<?php
require "../apps/controller/createPoolController.php";
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div class="row w-100 m-auto" >
			...
			<div class="col-lg-9 float-left col px-5 py-2 main mr-5 my-4 border rounded" style="background-color:#f5f5f5;">
			  	<div class="page-header text-center" >
                	<h3 class="mt-3">Create Exam</h3>
				</div>
				<hr class="pb-3">
				<h5 class="text-center lead text-dark">Please Insert all the required information to create an examination pool below <br>Star ( <span class="text-danger font-weight-bold">*</span> ) sign denotes mandetory fields.</h5>
				<div class="row my-3 mx-auto">
					<div class="col-lg-8 mx-auto">
                        <form action="" method="post">
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolToken" class="col-sm-5 col-form-label">Pool token no<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="createPoolToken" name="pool_token" placeholder="Enter token no" required>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="enterPortalToken" class="col-sm-5 col-form-label">Portal token no<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="enterPortalToken" name="portal_token" placeholder="Enter portal token no" required>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolCourseCode" class="col-sm-5 col-form-label">Course Code<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="createPoolCourseCode" name="course_code" placeholder="Enter Course Code" required>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolCourseName" class="col-sm-5 col-form-label">Course Name<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="createPoolCourseName" name="course_name" placeholder="Enter Course Name" required>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolDept" class="col-sm-5 col-form-label">Department<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="createPoolDept" name="dept" placeholder="Enter department Name" required>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolSemester" class="col-sm-5 col-form-label">Semester<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <select class="form-control" id="createPoolSemester" name="semester" required>
                            ...
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolYear" class="col-sm-5 col-form-label">Year<span class="text-danger">*</span></label></label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="createPoolYear" name="year" placeholder="Enter Year" required>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolInstitute" class="col-sm-5 col-form-label">Institute Name</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="createPoolInstitute" name="institute_name" placeholder="Enter Institute Name">
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolExamType" class="col-sm-5 col-form-label">Question Type<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <select class="form-control" id="createPoolExamType" name="exam_type" required>
                                        <option selected>Select any option</option>
                            ...
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolGenerateQue" class="col-sm-5 col-form-label">Generate Question<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <select class="form-control" id="createPoolGenerateQue" name="generate_by" required>
                                        <option selected>Select any option</option>
                            ...
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolQSName" class="col-sm-6 col-form-label">Question Setter Email<span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="createPoolQSName" name="que_setter_email" placeholder="Enter Question Setter Name" required>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolExamQueNo" class="col-sm-6 col-form-label">Number of Question(Exam)<span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="createPoolExamQueNo" name="num_exam_que" placeholder="Number of Question" required>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolTotalQueNo" class="col-sm-6 col-form-label">Number of Question(Total)<span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="createPoolTotalQueNo" name="num_total_que" placeholder="Number of Total Question" required>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolExamDate" class="col-sm-5 col-form-label">Exam Date<span class="text-danger">*</span></label>
                                <div class="col-sm-7 input-group">
                                    <input type="date" class="form-control" name="exam_date" id="createPoolExamDate" data-select="datepicker" required>
                                    <button type="button" class="btn btn-primary" data-toggle="datepicker"><i class="fa fa-calendar"></i></button>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolExamStartTime" class="col-sm-5 col-form-label">Exam Starts At<span class="text-danger">*</span></label>
                                <div class="col-sm-7 input-group clockpicker">
                                    <input type="text"  name="start_time" class="form-control" value="09:30AM">
                                    <button type="button" class="btn btn-primary input-group-addon"><i class="fa fa-clock"></i></button>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label class="col-sm-5 col-form-label">Exam Ends At<span class="text-danger">*</span></label>
                                <div class="col-sm-7 input-group clockpicker">
                                    <input type="text"  name="end_time" class="form-control" value="10:30AM">
                                    <button type="button" class="btn btn-primary input-group-addon"><i class="fa fa-clock"></i></button>
                                </div>
                            </div>
                            <div class="form-group row mt-3 mx-auto">
                                <label for="createPoolGenerateQue" class="col-sm-5 col-form-label">Duration (Hour)<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <select class="form-control" id="createPoolGenerateQue" name="duration" style="overflow: scroll;" required>
                                        <option selected>Select any option</option>
                            ...
                            <div class="form-group row mt-3 mx-auto my-5">
                                <button class="btn btn-success font-weight-bold mx-auto" name="submit_pool" id="createPoolSubmitBtn">Create New Pool</button>
                            </div>
                        </form>
					</div>
				</div>
