...
<html lang="en">
	<head>
	  <title>::.. Dashboard|Co-ordinator..::</title>
        <meta charset="utf-8">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                              <div class="card bg-info my-2" style="box-shadow: 1px 1px 10px black;">
                                <div class="card-header py-0 text-center">
                                    ...
                                    <span class="ml-3 my-0 py-0 fa-3x text-light" id="totalAcademicStudent">450</span>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                              <div class="card bg-secondary my-2" style="box-shadow: 1px 1px 10px black;">
                                <div class="card-header py-0 text-center">
                                    ...
                                    <span class="ml-3 my-0 py-0 fa-3x text-light" id="totalAcademicCandidate">300</span>
                                </div>
                                <div class="card-body text-center py-2">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                              <div class="card bg-warning my-2" style="box-shadow: 1px 1px 10px black;">
                                <div class="card-header py-0 text-center">
                                    ...
                                    <span class="ml-3 my-0 py-0 fa-3x text-light" id="totalAcademicExamPools">20</span>
                                </div>
                                <div class="card-body text-center py-2">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                              <div class="card bg-success my-2" style="box-shadow: 1px 1px 10px black;">
                                <div class="card-header py-0 text-center">
                                    ...
                                    <span class="ml-3 my-0 py-0 fa-3x text-light" id="totalAcademicExamComplete">15</span>
                                </div>
                                <div class="card-body text-center py-2">
                                ...
                                <table class="table table-bordered mt-4 mb-lg-5" style="box-shadow: 1px 1px 10px gray; ">
                                  ...
                                  <tbody>
                                    <tr class="text-center bg-light">
                                          <td>' .$portal_id.'</td>
                                          <td>'.$portal_name.'</td>
                                          <td><span>'.$institute_address.'</span></td>
                                          <td>
                                            <a href="createPool.php" class="btn btn-secondary font-weight-bold" id="createNewPoolBtn" name="createNewPool">Create New Pool</a>
                                          </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="container rounded px-0" style="box-shadow: 1px 1px 10px gray; margin-bottom: 30px;">
                             <ul class="nav nav-pills mx-auto bg-light border" role="tablist">
                                <li class="nav-item ml-1">
                                  <a class="nav-link active rounded-0" data-toggle="pill" href="#pendingPool">Pending Pool</a>
                                </li>
                                <li class="nav-item ml-1">
                                  <a class="nav-link rounded-0" data-toggle="pill" href="#myPool">My Pool</a>
                                </li>
                                <li class="nav-item ml-1">
                                  <a class="nav-link rounded-0" data-toggle="pill" href="#ended">Ended Exam</a>
                                </li>
                            </ul>
                            <div class="tab-content"   style="overflow-y: scroll; height: 600px;">
                                <div id="pendingPool" class="tab-pane fade in active show p-3">
                            ...
                            if ($count_pool > 0) {
                                While ($pool_row = mysqli_fetch_array($pool_exists)) {
                                    ...
                                    if ($current_date < $exam_date && $pool_approved != 1) {
                                        echo '<tr class="text-center bg-light">
                                          ...
                                          <td><span id="examPoolCode">' . $pool_token . '</span>
                                            <a class="fa fa-edit text-success" href="#" style="text-decoration: none;"  data-toggle="modal" data-target="#editExamDate"></a>
                                            <div class="modal fade" id="examPoolCode">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                      <!-- Modal Header -->
                                                      <div class="modal-header">
                                                        <h4 class="modal-title text-success"><span id="examPoolCourseCode">CSE112</span><small id="examPoolCourseName"> Computer Fundamentals </small></h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                      </div>
            
                                                      <!-- Modal body -->
                                                      <div class="modal-body">
                                                        <p class="mb-lg-4 mx-0">Please enter correct code below.</p>
                                                         <div class="form row m-auto">
                                                            <div class="col-lg-9 m-auto">
                                                                <div class="form-group row mx-auto">
                                                                    <label for="inputExamPoolCurrentCode" class="col-lg-5 col-form-label text-left">Enter current code</label>
                                                                    <input type="date" class="col-lg-7 form-control" id="inputExamPoolCurrentCode">
                                                                  </div>
                                                                  <div class="form-group row mx-auto">
                                                                    <label for="inputEditExamPoolCode" class="col-lg-5 col-form-label text-left">Enter new code</label>
                                                                    <input type="date" class="col-lg-7 form-control" id="inputEditExamPoolCode">
                                                                  </div>
                                                             </div>
                                                        </div>
                                                      </div>
                                          ...
                                          <td class="p-0">
                                            <button class="btn btn-sm btn-danger fa fa-trash" style="padding: 1px 4px 1px 6px;" id="examPoolDelete"  data-toggle="modal" data-target="#deleteExamPool" title="Delete Exam Pool" ></button>
                                            <div class="modal fade" id="deleteExamPool">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                      <!-- Modal Header -->
                                                      <div class="modal-header">
                                                        <h4 class="modal-title text-success"><span id="examPoolCourseCode">CSE112</span>-<small class="text-secondary" id="examPoolCourseName"> Computer Fundamental </small></h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                      </div>
                                                      ...
                                                      <!-- Modal footer -->
                                                      <div class="modal-footer">
                                                        <a href="../apps/controller/coOrdinatorController.php?delete='.$pool_id.'" type="button" class="btn btn-danger" id="examPoolDeleteBtn">Delete</a>
                                                      </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <button class="btn btn-sm btn-info fa fa-info-circle rounded" style="padding: 1px 4px 1px 6px;" data-toggle="modal" data-target="#infoExamPool1"></button>
                                ...
                                <div id="myPool" class="tab-pane fade in show p-3">
                                    <table class="table table-bordered mt-4 mb-lg-5">
                                      <thead>
                                        <tr class="bg-secondary text-center text-light">
                                          <th scope="col">Course Code</th>
                                ...
                                if ($count_pool > 0) {
                                    While ($pool_row = mysqli_fetch_array($pool_exists)) {
                                        ...
                                        <tr class="text-center bg-light">
                                          ...
                                          <td><span id="examPoolCode">' . $pool_token . '</span></td>
                                          <td class="p-0">
                                            <button class="btn btn-sm btn-danger fa fa-trash" style="padding: 1px 4px 1px 6px;" id="examPoolDelete"  data-toggle="modal" data-target="#deleteExamPool" title="Delete Exam Pool" ></button>
                                            <div class="modal fade" id="deleteExamPool">
                                                <div class="modal-dialog">
                                            ...
                                            <a href="addCandidate.php" class="btn btn-sm btn-success fa fa-user-plus" style="padding: 1px 4px 1px 6px;" id="addCandidate"  title="See Candidate List"></a>
                                            <a href="viewCandidateList.php" class="btn btn-sm btn-secondary fa fa-list" style="padding: 1px 4px 1px 6px;" id="examPoolStdList"  title="See Candidate List"></a>
                                            <button class="btn btn-sm btn-info fa fa-info-circle rounded" style="padding: 1px 4px 1px 6px;" data-toggle="modal" data-target="#infoExamPool2"></button>
                                ...
                                <div id="ended" class="tab-pane fade in p-3">
                                    <table class="table table-bordered mt-4 mb-lg-5">
                                      <thead>
                                        <tr class="bg-secondary text-center text-light">
                                          <th scope="col">Course Code</th>
                                ...
                                if ($count_pool > 0) {
                                    While ($pool_row = mysqli_fetch_array($pool_exists)) {
                                        ...
                                        <tr class="text-center">
                                          ...
                                          <td class="p-0">
                                            <a href="viewCandidateList.php" class="btn btn-sm btn-secondary fa fa-list" style="padding: 1px 4px 1px 6px;" id="examPoolStdList"  title="See Candidate List"></a>
                                            <button class="btn btn-sm btn-success fa fa-book" id="examPoolStdResult" style="padding: 1px 4px 1px 6px;"  data-toggle="modal" data-target="#viewPoolStudentResult" title="See Student Result"></button>
                                            <button class="btn btn-sm btn-info fa fa-info-circle rounded mx-1" style="padding: 1px 4px 1px 6px;" data-toggle="modal" data-target="#infoExamPool3"></button>
