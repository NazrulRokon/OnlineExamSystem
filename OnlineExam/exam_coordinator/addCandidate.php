<?php
require "../apps/controller/addCandidateController.php";
require "../apps/controller/inCompleteProfileChecker.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>::..Add Candidate|Coordinator..::</title>
    <meta charset="utf-8">
                ...
                <div class="form-inline my-2 my-lg-0">
                    <div class="btn-group dropdown" id="examPoolDropdown">
                        ...
                        <div class="dropdown-menu m-2 bg-secondary" aria-labelledby="dropdownMenuButton" id="examPoolDropmenu">
                            ...
                            <a class="dropdown-item bg-secondary text-light text-center" href="coOrdinatorDashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item bg-secondary text-light text-center" href="coOrdinatorProfile.php.php"><i class="fa fa-user-circle"></i> Profile</a>
                            <div class="dropdown-divider"></div>
...
<div class="row w-100 mx-auto">
    <div class="col-lg-8 float-left col px-5 py-2 main mx-auto my-4 border rounded" style="min-height: 600px;">
        <div class="page-header text-center" >
            <h3 class="mt-3">Add Candidate</h3>
        </div>
        <hr pb-1>
        <div class="card mx-auto my-lg-5 w-75"  style="box-shadow: 2px 2px 20px gray;">
            <div class="card-body pt-5" style="border-radius: 10px;">
                <form action="" method="post">
                    <p class="mx-auto text-center mb-4" style="font-family: Gotham, Helvetica Neue, Helvetica, Arial,' sans-serif'">* Please fill the form below to add Candidate<br>** Star ( <span class="text-danger font-weight-bold">*</span> ) sign denotes mandetory fields.</p>
                    ...
                    <div class="form-row mt-3">
                        <label class="col-form-label col-sm-3 ml-auto"><b>Clearance No<span class="text-danger">*</span></b></label>
                        <div class="col-sm-5 mr-auto">
                            <input type="text" class="form-control" name="clearance" placeholder="Enter Clearance" required>
                        </div>
                    </div>
                    <div class="form-row text-center mr-5 float-right">
                        <button type="submit" class="btn btn-primary my-3 mr-5 float-right px-4 py-2" name="addCandidate">ADD</button>
                    </div>
                </form>
            </div>
        </div>
